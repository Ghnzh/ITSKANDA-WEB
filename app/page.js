...
async function Home() {
  ...
  const renderJob = () => {
    return jobList.map((job) => <BoxModel key={job.id} name={job.nameJob} />);
  };
    ...
    <>
      <div data-aos="fade-down" className="h-screen text-center">
        <div className="h-[70%] w-full bg-ijo flex flex-col items-center justify-center pt-4">
          <h1
            data-aos="fade-right"
            className="text-4xl font-bold md:text-5xl lg:text-6xl capitalize text-kuning max-w-md md:max-w-[800px]"
          >
            raih masa Depan dengan Belajar teknologi
          </h1>
          <p
            data-aos="fade-left"
            className="text-sm text-cream md:text-xl max-w-[325px] md:max-w-2xl mt-8"
          >
            Transformasi Digital Membangun Masa Depan Yang Penuh Inovasi dan
            Peluang Tanpa batas
          </p>
        </div>
      ...
      <div className="lg:px-40 lg:mt-72 md:mt-20 lg:py-8 px-10 -mt-20 space-y-20 font-medium">
        <div className="lg:flex lg:space-x-28 lg:space-y-0 space-y-6">
          ...
          >
            Kenapa Belajar Teknologi?
          </h1>
          <p data-aos="fade-left" className="lg:w-3/5 lg:text-xl lg:max-w-xl">
            <span>
              Teknologi terus berkembang dengan cepat. Dengan belajar teknologi,
              kamu akan dapat mengikuti perkembangan terbaru dan terus
              memperbarui keterampilan kamu.
            </span>
            <br />
            <br />
            <span>
              {" "}
              Oleh karena itu, Kami Menyiapkan pembelajaran yang komprehensif
              dan berorientasi pada masa depan untuk memastikan bahwa kamu
              memiliki keterampilan yang relevan dan diperlukan di dunia
        ...
        <div className="lg:flex lg:space-x-28 lg:space-y-0 space-y-6">
          <h1
            ...
            className="lg:w-2/5 font-bold lg:text-[40px] text-4xl"
          >
            Prospek Kerja Bidang IT
          </h1>
          <div
            data-aos="fade-left"
            className="lg:w-3/5 lg:text-xl lg:max-w-xl lg:space-y-6 space-y-4"
          >
            <p>
              Ada banyak peluang kerja yang tersedia bagi pelajar IT, beberapa
              di antaranya adalah:
            </p>
