...
async function Page() {
  const dataPPLG = await prisma.pplg.findMany();
  ...
  return (
    <>
      <Header judul="PPLG" desc="Pengembangan Perangkat Lunak dan Gim" />
      <div className="lg:px-24 px-10 pb-14 -mt-60 md:-mt-40">
        <div className="lg:flex lg:space-x-12 lg:space-y-0 space-y-6">
          ...
          <p data-aos="fade-left" className="lg:w-3/5 lg:text-xl font-medium">
            Jurusan ini mempelajari dan mendalami cara-cara mengembangkan
            perangkat lunak. Mulai dari pembuatan, pemeliharaan, manajemen
            kualitas, dan manajemen organisasi pengembangan perangkat lunak.
            <br />
            <br />
            Selain itu, jurusan PPLG juga berhubungan dengan software komputer
            seperti pembuatan aplikasi, website, game dan semua yang berhubungan
            dengan pemrograman. Singkatnya, jurusan PPLG erat kaitannya dengan
            coding, desain, dan algoritma.
          </p>
        </div>
        <h1
          data-aos="fade-right"
