...
import CardAchievement from "@/components/cardAchiev";
...
export default function achievementsPage() {
    ...
    return (
        ...
        <div className="h-screen text-center">
            ...
            <h1 className="text-4xl font-bold md:text-5xl lg:text-6xl text-kuning max-w-xs lg:max-w-full text-center z-50">Our Achievements</h1>
            </div>
        ...
        <div className="bg-cream lg:px-36 lg:py-28 px-10 py-12 -mt-60 rounded-t-3xl">
