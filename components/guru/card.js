  ...
  return (
    <>
      <div>
        <div
          data-aos="fade-up"
          className="bg-nav hover:bg-ijo hover:text-nav cursor-pointer px-8 py-6 rounded-xl w-full text-left"
          onClick={handleClick}
        >
        ...
        <div role="dialog" aria-modal="true">
          <div focus="true" className={`${active ? "" : "hidden"}`}>
            <div className="fixed inset-0 flex items-center justify-center z-50">
              ...
              <div className="bg-cream p-6 lg:p-12 mt-12 rounded-xl w-[90%] lg:w-1/2 relative z-10 font-medium">
                <div className="flex justify-end" onClick={handleClick}>
                  <button className="bg-kuning text-ijo p-3 lg:-mt-16 lg:-mr-16 rounded-full h-fit hover:rotate-90 duration-500">
                ...
                <div className="lg:flex lg:space-x-5 space-y-4 lg:space-y-0 -mt-4">
                  <div>
                    <div className="lg:px-6 px-4 py-2 rounded-lg bg-kuning w-fit relative z-10 ">
                      <h1 className="text-[12px] lg:text-base">Foto</h1>
                    </div>
                    <div className="-mt-3 ml-4 p-3 lg:p-6 bg-white rounded-xl w-fit">
                      <Image
                        src={guru.img}
                        width={150}
                        height={150}
                  ...
                  <div className="space-y-4 lg:w-full">
                    <div>
                      <div className="lg:px-6 px-4 py-2 rounded-lg bg-kuning w-fit relative z-10 ">
                        <h1 className="text-[12px] lg:text-base">
                          Nama & Bidang Studi
                        </h1>
                      </div>
