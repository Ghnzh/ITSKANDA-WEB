...
const Facility = () => {
  return (
    <div className="lg:px-40 lg:py-12 px-10 text-ijo font-bold">
      <h1 data-aos="fade-right" className="lg:text-5xl text-4xl">
        Facility
      </h1>
      <div
        data-aos="fade-up"
        className="grid lg:grid-cols-3 bg-nav lg:mt-10 mt-6 rounded-xl lg:text-2xl text-xl lg:py-8 lg:px-0 px-8"
      >
