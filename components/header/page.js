const Header = ({judul, desc}) => {
    return (
        <div data-aos="fade-down" className="h-screen text-center">
            ...
            <h1 data-aos="fade-right" className="text-[40px] font-bold md:text-5xl lg:text-6xl text-kuning max-w-xs lg:max-w-full">{judul}</h1>
            <p data-aos="fade-left" className="text-cream text-lg lg:text-xl lg:mt-4">{desc}</p>
            </div>
